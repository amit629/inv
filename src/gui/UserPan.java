...
public class UserPan extends JPanel {
	...
	private Rectangle l1Bnds;
	private Rectangle l2Bnds;
	private Rectangle l3Bnds;
	private Rectangle l4Bnds;
	private Rectangle l5Bnds;
	/**
	 * Create the panel.
	 */
	
	public Font getNewSize(JLabel label) {
	...
	public UserPan(DatabaseConnection db,UserDetails userDet,JFrame frame) {
		setLayout(null);
		
		JTabbedPane tabbedPane = new JTabbedPane(JTabbedPane.TOP);
		tabbedPane.setBounds(10, 10, 701, 463);
		add(tabbedPane);
		...
		pp1.add(lblNewLabel_5);
		 ...
		 l1Bnds=lblNewLabel_1.getBounds();
		 l2Bnds=lblNewLabel_2.getBounds();
		 l3Bnds=lblNewLabel_3.getBounds();
		 l4Bnds=lblNewLabel_4.getBounds();
		 l5Bnds=lblNewLabel_5.getBounds();
		...
		frame.addComponentListener(new FrameChange() {
			...
			public void componentResized(ComponentEvent arg0) {
				...
				int dashBoardWidth=(frameWidth*(26))/100;
				int offsetx=(frameWidth*2)/100;
				int offsety=(frameHeight*2)/100;
		        int userContainerWidth=frameWidth-dashBoardWidth;
				int userContainerHeight=frameHeight-((frameHeight*(8))/100);
		        
//				tabbedPane.setSize(userContainerWidth,userContainerHeight);
				
				
				tabbedPane.setBounds(offsetx,offsety,(int)(userContainerWidth-(1.5*offsetx)),(int)(userContainerHeight-(1.5*offsety)));
				
				int connWidth=tabbedPane.getSize().width;
				int connHeight=tabbedPane.getSize().height;
//				
//				Font lb1F=lblNewLabel_1.getFont();
//				
//				lblNewLabel_1.setFont(new Font());
				
//				int AllCompNewOffSetX=(int)(connWidth*2)/100;
//				int AllCompNewOffSetY=(int)(connHeight*5)/100;
//				int labelWidth=(connWidth*10)/100;
//				int labelHeight=(connHeight*10)/100;
//				
				
//				Font Sz=getNewSize(lblNewLabel_1);
//				lblNewLabel_1.setBounds(l1Bnds.x+AllCompNewOffSetX,l1Bnds.y+AllCompNewOffSetY+1, labelWidth, labelHeight);
//				
//				lblNewLabel_1.setFont(getNewSize(lblNewLabel_1));
//				
//				lblNewLabel_2.setBounds(l2Bnds.x+(6*AllCompNewOffSetX),l2Bnds.y+AllCompNewOffSetY+3, labelWidth, labelHeight);
//				
//				lblNewLabel_2.setFont(getNewSize(lblNewLabel_1));
//				
//				lblNewLabel_3.setBounds(l3Bnds.x+AllCompNewOffSetX,l3Bnds.y+AllCompNewOffSetY+5, labelWidth, labelHeight);
//			
//				lblNewLabel_3.setFont(getNewSize(lblNewLabel_1));
//				
//				lblNewLabel_4.setBounds(l4Bnds.x+AllCompNewOffSetX,l4Bnds.y+AllCompNewOffSetY+8, labelWidth, labelHeight);
//				
//				lblNewLabel_4.setFont(getNewSize(lblNewLabel_1));
//				
//				lblNewLabel_5.setBounds(l5Bnds.x+AllCompNewOffSetX,l5Bnds.y+AllCompNewOffSetY+10, labelWidth, labelHeight);
//				
//				lblNewLabel_5.setFont(getNewSize(lblNewLabel_1));
				
//				int AllInpNewOffSetX=(int)(connWidth*4)/100;
//				int AllInpNewOffSetY=(int)(connHeight*14)/100;
//				
//				int f1width=(connWidth*30)/100;
//				int f2width=(connWidth*80)/100;
//				addUsernameField.setBounds(l1Bnds.x+AllInpNewOffSetX,l1Bnds.y+AllInpNewOffSetY, f1width, addUsernameField.getSize().height);
//				AddEmailField.setBounds(l3Bnds.x+AllInpNewOffSetX,l3Bnds.y+AllInpNewOffSetY,f2width, addUsernameField.getSize().height);
//				AddPasswordField.setBounds(l4Bnds.x+AllInpNewOffSetX,l4Bnds.y+AllInpNewOffSetY, f2width, addUsernameField.getSize().height);
//				addNameField.setBounds(addUsernameField.getBounds().x,l2Bnds.y+AllInpNewOffSetY, f1width, addUsernameField.getSize().height);
//				AddEmailField;
//				AddPasswordField;
//				addNameField;
